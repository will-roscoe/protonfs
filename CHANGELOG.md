...
- **push**: re-upload a changed file as a Drive revision, and never index one the listing cannot size (#155)
...
- **drive**: read claimedSize/claimedDigests from the revision, not the entry

## [1.11.2] - 2026-08-14

### Bug fixes

- **drive**: stop orphaning proton-drive, name the cache-lock fault, and distinguish phantom nodes (#143)
...
- **pull**: verify downloads against the local filesystem instead of trusting counts (#133)
